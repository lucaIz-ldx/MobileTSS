...
/* i/o */
    // 1: signed, 0: not-signed, less-than 0: error.
//int tss_request_send_with_return_code(plist_t request, const char* server_url_string, plist_t *tss_response);
...
int tss_response_get_blob_by_path(plist_t response, const char* path, unsigned char** blob, TSSCustomUserData *userData);
